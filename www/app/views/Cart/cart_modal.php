            ...
            <table class="table text-start">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="cart-qty"><?= $_SESSION['cart.qty'] ?></td>
                    </tr>
                    <tr>
                        <td colspan="4" class="text-end"><?= ___('tpl_cart_sum') ?></td>
                        <td colspan="4" class="cart-sum">$<?= $_SESSION['cart.sum'] ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div class="modal-footer">
    ...
    <?php if(!empty($_SESSION['cart'])): ?>
        ...
        <button type="button" class="btn btn-danger" id="clear-cart"><?= ___('tpl_cart_btn_clear') ?></button>
    <?php endif; ?>
</div>